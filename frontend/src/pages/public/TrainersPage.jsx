...
const getImageUrl = (image) => {
    if (!image) {
        return "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=400&h=500&fit=crop";
    }
...
const TrainersPage = () => {
    ...
    const fetchTrainers = async () => {
        try {
            const response =
                await trainerAPI.getPublic({ active: "true" })
                ...
                <div className="container-custom">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16">
                            ...
                            <h3 className="font-heading text-2xl font-semibold text-dark-900 mb-2">
