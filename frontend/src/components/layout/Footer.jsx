                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="space-y-3">
                            <Link to="/" className="flex items-center gap-2">
                                ...
                                <span className="font-heading font-bold text-2xl">Endless Gym</span>
                            </Link>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span className="text-dark-400">Opposite durga mata temple,Choani, Nagpur</span>
                                </li>
                                ...
                                <li className="flex items-center gap-3">
                                    ...
                                    <span className="text-dark-400">+91 90964 08523</span>
                                </li>
                                ...
                                <li className="flex items-center gap-3">
                                    ...
                                    <span className="text-dark-400">syedsahil22072000@gmail.com</span>
                                </li>
                            </ul>
                        </div>
